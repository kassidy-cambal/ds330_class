"""A neural network is a collection of layers. In this case, 
we're calling it either a multilayer preceptron because we're creating
fully connected neural networks"""

from typing import Iterator

from DS330_class.cuppajoe import layer, tensor

class MLP():
    def __init__(self, layers: list[layer.Layer]):
        self.layers = layers

        def forward(self, x = tensor.Tensor, labels = tensor.Tensor) -> tensor.Tensor:
